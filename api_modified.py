...
@v1_router.get("/api/auth/validate")
async def validate_token():
    return {"status": "valid"}

@v1_router.get("/api/auth/branding")
...
@v1_router.get("/api/jobs/{job_id}/wait")
...
@v1_router.post("/api/jobs/{job_id}/cancel")
...
@v1_router.get("/api/jobs/{job_id}/document/{doc_type}", response_class=PlainTextResponse)
...
@v1_router.get("/api/documents/{base_name}/data")
...
@v1_router.get("/api/documents/{base_name}/{doc_type}", response_class=PlainTextResponse)
...
@v1_router.get("/api/organization")
...
@v1_router.put("/api/organization")
...
@v1_router.post("/api/organization/apply-branding-history")
...
@v1_router.post("/api/organization/{slot}")
...
@v1_router.get("/api/debug/org-profile")
...
@v1_router.delete("/api/organization/{slot}")
...
@v1_router.post("/api/estimations/manual")
...
@v1_router.post("/api/estimations/{base_name}/invoice")
...
@v1_router.get("/api/estimations/{base_name}/invoice")
...
@v1_router.put("/api/estimations/{base_name}/invoice/status")
...
@v1_router.put("/api/documents/{base_name}/{doc_type}")
...
@v1_router.get("/api/documents/{base_name}/{doc_type}/pdf")
...
@v1_router.get("/api/config/status")
...
@v1_router.patch("/api/estimations/{id}")
...
@v1_router.delete("/api/estimations/{id}")
...
@v1_router.patch("/api/invoices/{id}")
...
@v1_router.delete("/api/invoices/{invoice_number}")
