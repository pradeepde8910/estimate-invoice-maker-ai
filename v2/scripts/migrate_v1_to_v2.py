...
from v2.models.base import Base as V2Base
from v2.models.master import Client as V2Client, User as V2User
from v2.models.project import Project as V2Project, ProjectBillingConfig as V2BillingConfig
    ...
    try:
        ...
        for v1_e in v1_estimations:
            ...
            if not v2_p:
                ...
                from v2.models.master import BillingType
