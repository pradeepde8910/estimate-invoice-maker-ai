...
CSS = """
* { box-sizing: border-box; margin: 0; padding: 0; font-family: "Google Sans Flex", "Google Sans", "Segoe UI", -apple-system, BlinkMacSystemFont, Roboto, Helvetica, Arial, sans-serif; font-variant-numeric: tabular-nums; }
body { background-color: #F1F5F9; color: #334155; padding: 40px 12px; font-size: 13px; line-height: 1.5; -webkit-font-smoothing: antialiased; text-rendering: optimizeLegibility; }
