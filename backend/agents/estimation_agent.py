...
4. Identify what technologies, infrastructure, and third-party services are needed.
   List them explicitly as resource requirements (e.g., PostgreSQL database, SMS API, LLM inference).
...
You MUST respond with ONLY valid JSON:
{
  ...
  "resource_requirements": [
    {
      "resource_name": "string (e.g., PostgreSQL database, SMS API, Object Storage)",
      "category": "infrastructure|license|third_party",
      "reasoning": "string — why this is needed based on the analysis"
    }
  ],
  "team_composition": [
    {
...
async def estimation_node(state: PipelineState) -> dict:
    ...
    Extracts resource requirements to be resolved against the pricing catalog.
    """
...
3. Identify specific infrastructure and third-party resources needed
...
"""
        ...
        try:
            ...
            estimation_data = {
                ...
                "resource_requirements": [{"resource_name": "Cloud Hosting", "category": "infrastructure", "reasoning": "General hosting environment"}],
                "team_composition": [],
                "timeline_weeks": 12,
                "phases": []
            }
        ...
        cost_estimation = {
            ...
            "infrastructure_cost_monthly": 0,  # calculated later
            "third_party_licenses_monthly": 0,  # calculated later
            ...
            "resource_requirements": estimation_data.get("resource_requirements", []),
        ...
        log.append(f"      Resource requirements identified: {len(estimation_data.get('resource_requirements', []))}")
